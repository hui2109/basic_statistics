...
if __name__ == '__main__':
    ...
    # NCRT治疗前AE
    source_1_1 = open_specific_path('ceus_pre', 'Mean', 'PCA', 'ANOVA_17', 'AE')
    source_1_2 = open_specific_path('ceus_pre', 'Mean', 'PCA', 'RFE_17', 'AE')
    source_1_3 = open_specific_path('ceus_pre', 'Mean', 'PCA', 'Relief_17', 'AE')  # **
    source_1_4 = open_specific_path('ceus_pre', 'Mean', 'PCA', 'KW_17', 'AE')
    data_1 = {
    ...
    species = ['ANOVA', 'RFE', 'Relief' + sample, 'KW']
    ...
    # NCRT治疗前RF
    source_2_1 = open_specific_path('ceus_pre', 'Zscore', 'PCA', 'ANOVA_7', 'RF')
    source_2_2 = open_specific_path('ceus_pre', 'Zscore', 'PCA', 'RFE_7', 'RF')  # **
    source_2_3 = open_specific_path('ceus_pre', 'Zscore', 'PCA', 'Relief_7', 'RF')
    source_2_4 = open_specific_path('ceus_pre', 'Zscore', 'PCA', 'KW_7', 'RF')
    data_2 = {
        'cross-validation training set': (
    ...
    species = ['ANOVA', 'RFE' + sample, 'Relief', 'KW']
    draw_grouped_histogram(ax[0, 1], species, data_2, 'RF model before NCRT')
    add_fig_num(ax[0, 1], 'B')

    # NCRT治疗后AE
    source_3_1 = open_specific_path('ceus_post', 'Zscore', 'PCC', 'ANOVA_8', 'AE')
    source_3_2 = open_specific_path('ceus_post', 'Zscore', 'PCC', 'RFE_8', 'AE')
    source_3_3 = open_specific_path('ceus_post', 'Zscore', 'PCC', 'Relief_8', 'AE')
    source_3_4 = open_specific_path('ceus_post', 'Zscore', 'PCC', 'KW_8', 'AE')  # **
    data_3 = {
        'cross-validation training set': (
    ...
    species = ['ANOVA', 'RFE', 'Relief', 'KW' + sample]
    draw_grouped_histogram(ax[1, 0], species, data_3, 'AE model after NCRT')
    add_fig_num(ax[1, 0], 'C')

    # NCRT治疗后RF
    source_4_1 = open_specific_path('ceus_post', 'Mean', 'PCC', 'ANOVA_4', 'RF')
    source_4_2 = open_specific_path('ceus_post', 'Mean', 'PCC', 'RFE_4', 'RF')
    source_4_3 = open_specific_path('ceus_post', 'Mean', 'PCC', 'Relief_4', 'RF')
    ...
    plt.savefig('./saved_figs/Figure 3.jpg', bbox_inches='tight')
    plt.show()
